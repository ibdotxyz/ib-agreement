...
describe("Uniswap v2 converter", () => {
  ...
  beforeEach(async () => {
    ...
    const converterFactory = await ethers.getContractFactory("UniswapV2Converter");
  ...
  it('convert PERP for exact USDC', async () => {
    ...
    await converter.connect(ibAgreement).convertTokensForExactTokens(receivedAmount, ethers.constants.MaxUint256);
